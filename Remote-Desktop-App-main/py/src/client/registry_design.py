...
class RegistryDesign(QMainWindow):
    def __init__(self):
        ...
        self.buttonBrowse.setGeometry(295, 20, 75, 25)
        ...
        self.editBox = QGroupBox("Sửa trực tiếp", self)
        ...
        self.optionApp.addItems(["Get Value", "Set Value", "Delete Value", "Create Key", "Delete Key"])
        ...
        self.optionTypeValue.addItems(["String", "Binary", "DWORD", "QWORD", "Multi-String", "Expandable String"])
